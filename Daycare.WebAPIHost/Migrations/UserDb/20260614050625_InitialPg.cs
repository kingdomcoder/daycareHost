...
namespace Daycare.WebAPIHost.Migrations.UserDb
{
    ...
    public partial class InitialPg : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Shimei = table.Column<string>(type: "text", nullable: true),
                    Myoji = table.Column<string>(type: "text", nullable: true),
                    ...
                    UTCdiff = table.Column<int>(type: "integer", nullable: true),
                    ...
                    LastAccessedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            // M2 NOTE: ChatMessage / ChatUser テーブルは MyDbContext(AppDb) の InitialPg が作成する。
            // 両コンテキストが同一 Postgres DB を共有するため、ここでの重複作成を削除して衝突を回避する。
            // モデルスナップショットには残しているので getMyChatUsers の userContext 経由 JOIN は引き続き機能する。
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // M2 NOTE: ChatMessage / ChatUser の DropTable は AppDb 側が担当するためここでは行わない。
